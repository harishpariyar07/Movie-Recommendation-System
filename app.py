...
def recommend(movie):
    ...
    for i in movies_list:
        ...
        recommended_movie_imdbRating.append(imdb.loc[imdb['tconst'] == imdb_id , 'averageRating'].item())
...
if st.button('Show Recommendations',):
    st.divider()
    recommended_movie_names, recommended_movie_posters, recommended_movie_overview, recommended_movie_imdbRating, imdbID = recommend(selected_movie_name)
    ...
    with col1:
        ...
        recommended_movie_names[0] ='['+recommended_movie_names[0]+'](%s)' %url
    ...
    with col1:
        ...
        recommended_movie_names[1] ='['+recommended_movie_names[1]+'](%s)' %url
    ...
    with col1:
        ...
        recommended_movie_names[2] ='['+recommended_movie_names[2]+'](%s)' %url
    ...
    with col1:
        ...
        recommended_movie_names[3] ='['+recommended_movie_names[3]+'](%s)' %url
    ...
    with col1:
        ...
        recommended_movie_names[4] ='['+recommended_movie_names[4]+'](%s)' %url
